...
const ParentTransactionScreen: React.FC = () => {
  ...
  const handleChildSelect = (childId: number) => {
    ...
    if (student) {
      console.log('Setting studentClassId:', student.studentClassId);
    ...
    <div className="max-w-xl mx-auto">
      <Card className="shadow-2xl rounded-2xl border-0">
        <div className="text-center mb-10">
          <h2 className="text-4xl font-extrabold text-gray-900 mb-3">Đóng học phí</h2>
          <p className="text-lg text-gray-600">Vui lòng chọn thiếu nhi bạn muốn đóng học phí</p>
        </div>
        ...
        >
          <Form.Item
            name="childId"
            label={<span className="text-base font-medium">Chọn thiếu nhi</span>}
